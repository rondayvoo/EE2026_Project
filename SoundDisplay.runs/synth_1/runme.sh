...
HD_PWD='C:/Users/rondayvoo/Documents/Vivado/SoundDisplay/SoundDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audiolevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audiolevel.tcl
