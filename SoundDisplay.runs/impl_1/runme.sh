...
HD_PWD='C:/Users/rondayvoo/Documents/Vivado/SoundDisplay/SoundDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log audiolevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source audiolevel.tcl -notrace
